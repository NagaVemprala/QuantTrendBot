...
with st.sidebar:
    ...
    if st.button("Example 1: Momentum"): st.session_state.query = q1
    if st.button("Example 2: Trend"): st.session_state.query = q2
    if st.button("Example 3: Volatility"): st.session_state.query = q3
